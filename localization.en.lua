...
SMARTBUFF_WHATSNEW = "\n\n|cffffffff        Whats new:|r\n\n"
  ...
  .."          Changes in r22:\n\n"
  .."             * Fixed a LUA error under WOTLK Beta linked to\n"
  .."                Dampen Magic (missing level ranges). \n"
  .."             * Added support for more missing items.\n"
  .."             * Added quick temporary fix for wotlk buffing.\n"
  .."\n\n"
