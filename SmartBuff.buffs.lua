...
function SMARTBUFF_InitSpellList()
  ...
  if (SMARTBUFF_PLAYERCLASS == "PRIEST") then
    SMARTBUFF_BUFFLIST = {	
	  ...
	  {SMARTBUFF_DS, 30, SMARTBUFF_CONST_GROUP, {40,42,54,60,70,80}, "ROGUE;WARRIOR;HPET;WPET;DKPET", nil, nil, SMARTBUFF_POSRB1, 60, {60}, {SMARTBUFF_SACREDCANDLE}},
  ...
  if (SMARTBUFF_PLAYERCLASS == "MAGE") then
    SMARTBUFF_BUFFLIST = {
	  ...
	  {SMARTBUFF_ABRB1, 60, SMARTBUFF_CONST_GROUP, {56, 70, 80}, "ROGUE;WARRIOR;HPET;WPET;DKPET", {SMARTBUFF_ARCANEPOWDER}, S.ChainMageBuffs},
